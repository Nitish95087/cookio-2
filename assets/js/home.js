...
$searchBtn.addEventListener("click", function(){
    if($searchField.value) {window.location = `/recipe.html?q=${$searchField.value}`};
})
...
for(const [index, $sliderSection] of $sliderSections.entries()){
  ...
  <div class="container">
    <h2 class="section-title headline headline-small" id="slider-label-1">Latest ${cuisineType[index]} Recipes</h2>
